...
if (isset($_POST['btnlogin'])) {
    ...
    if ($uname == '' OR $h_upass == '' ) {
			?>   <script type="text/javascript">
                alert("Username and Password cannot be Empty.Please Check!");
                </script>
            <?php
			...
			$cur = $user::Authenticateassessor($uname, $h_upass);
			...
			if($cur == true){
				...
				?>    <script type="text/javascript">
	                alert("Username or Password Not Registered in Assessor's Module! Please Contact Your administrator.");
	                window.location = "index.php";
	                </script>
	       	 <?php
	        }
