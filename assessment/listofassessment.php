	...
	?>
		<div class="well">
				...
				<table class="table table-hover">
				  ...
				  <thead>
				  	<tr>
				  		<th width="20%"> <input type="checkbox" name="chkall" id="chkall" onclick="return checkall('selector[]');"> Assessment ID.</th>
				  		<th width="20%">Term</th>
				  		<th width="25%">Academic Year</th>
				  		<th width="20%">Status</th>
				  		<th width="15%">Optons</th>
				  	  ...
				  	  @$idno =  $_GET['studentId'];
				  		...
				  		function loadresult(){
							...
							foreach ($cur as $assessment) {
					  		...
					  		echo '<td><a href = "assess_student.php?assessmentId='.$assessment->assessment_id.'" >Assess Student</a></td>';
					  		echo '</tr>';
					  		}
