...
<div class="container">
	...
	$tt5 = $row2a[2];
				...
				<div class="btn-group">
				  <a href="instructor_subjects.php?instructorId=<?php echo $instructor_id; ?>&term=<?php echo $tt; ?>&ay=<?php echo $ayy2; ?>" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span> Back</a>
