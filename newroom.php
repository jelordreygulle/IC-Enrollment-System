						...
						<legend><span  class="glyphicon glyphicon-plus-sign">  </span>  New Room</legend>
						 ...
						 <div class="form-group">
				            <div class="col-md-8">
				              ...
				              <div class="col-md-8">
				                <button class="btn btn-success" name="saveroom" type="submit" ><span class="glyphicon glyphicon-floppy-save"></span> Save</button>
				               <button class="btn btn-info" name="saveandnewroom" type="submit" ><span class="glyphicon glyphicon-saved"></span> Save and Add new</button>
				              </div>
				            </div>
				          </div>
