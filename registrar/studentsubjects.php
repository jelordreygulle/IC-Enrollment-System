					...
					<caption><h3 align="left"><?php echo $acad_year; ?> - <?php echo $term; ?> List of Subjects</h3><hr/></caption>
					 <thead>
					  ...
					  <!-- 	<tr><td colspan="2">Date Printed:  <? //print(Date("l F d, Y")); ?> .</td><td colspan="2">Advised and signed by:</td><td ></td></tr>  -->
						...
						<div class="btn-group">
						<a href="studentrecords.php?studentId=<?php echo $stu_id; ?>" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span> Back</a>
						<a href="preview_cor.php?studentId=<?php $stu_id; ?>&ay=<?php $acad_year; ?>&term=<?php $term; ?>" class="btn btn-warning"><span class="glyphicon glyphicon-print"></span> Print</a>
