					  	...
					  	<?php
				 			$cid = (isset($studcourse)) ? $studcourse->course_id : 0;
								...
								foreach ($cur as $result) {
							  		...
							  		echo '<td><a href="studentsubjects.php?term='.$result->term.'&year='.$result->AY.'&stu_id='.$idno.'" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span> Preview</a></td>';

							  		echo '<td><a href="preview_cor.php?studentId='.$idno.'&ay='.$result->AY.'&term='.$result->term.'" class="btn btn-warning"><span class="glyphicon glyphicon-print"></span>  Print</a></td>';
