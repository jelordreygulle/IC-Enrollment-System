				  ...
				  <table class="tftable">
					<caption><h3 align="left">Enrollment Records</h3><hr/></caption>
					  ...
					  <tbody>
					  	<?php
				 			$cid = (isset($studcourse)) ? $studcourse->course_id : 0;
								...
								foreach ($cur as $result) {
							  		...
							  		echo '<td><a href="studentsubjects_grades.php?term='.$result->term.'&year='.$result->AY.'&stu_id='.$idno.'" ><span class="glyphicon glyphicon-eye-open"></span> View Subjects</a></td>';
						...
						<div class="btn-group">
					<a href = "listofstudent_grades.php?idno=&lname=&fname=" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span>  Back</a>
