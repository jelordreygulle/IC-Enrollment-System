...
<div class="container">
	...
	?>
		<div class="well">
				  	  ...
				  	  if ($idno == '' AND $lname=='' AND $fname == ''){
				  		...
				  		function loadresult(){
							...
							foreach ($cur as $student) {
					  		...
					  		echo '<td><a href = "studentrecords_grades.php?studentId='.$student->student_id.'" >Enrollment Records</a></td>';
					  		echo '</tr>';
					  		}
				...
				<div class="btn-group">
				  <a href="filter_grades.php" class="btn btn-danger"><span class="glyphicon glyphicon-search"></span> Search</a>
				</div>
				</form>
	  	</div><!--End of well-->
