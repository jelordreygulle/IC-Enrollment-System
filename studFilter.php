		  ...
		  <form class="form-horizontal span4" action="#.php" method="POST">
					...
					<div class="panel panel-primary">
					  <div class="panel-heading">
					    <h3 class="panel-title"><span class="glyphicon glyphicon-filter"></span>Student Query Options</h3>
					  </div>
				               ...
				               <label class="col-md-4 control-label"></label>
				                ...
				                <div class="col-md-8">
							         <div class="btn-group">
									    ...
									    <a href="newstudent.php" name="add" class="btn btn-success"> <span class="glyphicon glyphicon-plus"></span> Add</a>
