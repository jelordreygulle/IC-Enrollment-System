...
class SubjPagination_offerred {
	...
	function count_allrecords($ay="", $term = ""){
		global $mydb;
		$mydb->setQuery("SELECT * FROM ".self::$tbl_name."Where AY= {$ay} and semester = {$term}");
