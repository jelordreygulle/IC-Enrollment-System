			    ...
			    $fell_count = $fell_row[0];
				    ...
				    if($fell_count > 0){
				    	...
				    	?>    
						    ...
						    ?>    
					    	<script type="text/javascript">
			                	alert("There is Conflict in time start and time end with the schedule of the instructor.Please Check!");
			                </script>
	           				 <?php
								...
								$istrue = $load->create(); 
								 ...
								 if ($istrue == 1){
								 	...
								 	redirect('assignInstructorSubjects.php?instructorId=1&term=First Semester&ay=2016-2017');
								 }
