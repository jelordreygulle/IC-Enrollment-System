            ...
            <div class="col-5 col-sm-5 col-lg-5">
					...
					<div class="panel panel-primary">
					  ...
					  <div class="panel-body">
						...
						<?php
						$mine = "SELECT CONCAT( `tbl_student`.`lname` , ', ', `tbl_student`.`fname` , ' ', `tbl_student`.`mname` ) AS 'name', `tbl_course`.`course_code` , `tbl_course`.`AY` , `tbl_student`.`student_id`, `tbl_course`.`course_id`
...
<table id="table" width="100%">
							<tbody>
								<tr>
									...
									<td width="40%"><span style="font-size:6px;">: <?php echo $_SESSION['fullname']; ?></span></td>
