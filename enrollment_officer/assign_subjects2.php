...
if (isset($_POST['saveofferedsubject'])){
	...
	if ( $_POST['subject'] == "" OR $_POST['course'] == "" OR $_POST['section'] == ""  OR $_POST['slot'] == "" OR $_POST['room'] == "" OR $_POST['slot'] == "startime" OR $_POST['endtime'] == "" OR $_POST['ins'] == ""    ) {
						...
						<div class="form-group">
				          ...
				          <div class="form-group">
				            <div class="col-md-8">
				              ...
				              <div class="col-md-8">
				              	 <select  class="form-control input-sm" id="ins" name="ins" required >
				              	<option value=""></option>
				                <?php
				                  	$ins = new Instructor();
				                  	$cur = $ins->listOfinstructor();	
				                  	foreach ($cur as $ins) {
				                  		echo '<option value="'. $ins->instructor_id.'">'.$ins->name.'</option>';
				                  	}
						 ...
						 <div class="form-group">
				            <div class="col-md-8">
				              ...
				              <div class="col-md-8">
				                ...
				                <a href="offerred_subject.php" class="btn btn-warning"><span class="glyphicon glyphicon-arrow-left"></span> Back</a>
				                 </div>
				            </div>
				          </div>
