						...
						<a href="studentrecords.php?studentId=<?php echo $stu_id; ?>&course=<?php echo $course_id; ?>" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span> Back</a>
							...
							if($row2a == 1){
								...
								if($row_imong_course[0] == $course_id){
									...
									echo '<a href = "assignstudentsubjects.php?id='.$stu_id.'&course='.$course_id.'&term='.$term.'&ay='.$acad_year.'" disabled class="btn btn-success"><span class="glyphicon glyphicon-plus-sign"></span> Assign Subject</a>';
									  ...
									  echo '<a href="preview_pef.php?studentId='.$stu_id.'&term='.$term.'&ay='.$acad_year.'" disabled class="btn btn-info"><span class="glyphicon glyphicon-print"></span> Print PEF</a>**You dont have any privillage to assign, delete and print PEF. Please Check the course.';
								...
								echo '<a href="preview_pef.php?studentId='.$stu_id.'&term='.$term.'&ay='.$acad_year.'" disabled class="btn btn-info"><span class="glyphicon glyphicon-print"></span> Print PEF</a>';
								echo '<button type="submit" disabled class="btn btn-danger" name="delete"  data-toggle="modal" data-target="#delete_mandatory"><span class="glyphicon glyphicon-trash"></span> Delete Selected</button>
								...
								echo '<a disabled class="btn btn-success"><span class="glyphicon glyphicon-plus-sign"></span> Assign Subject</a>***This AY and Term is conflict with the other active AY and Term. Please Contact you administrator.';
								...
								echo '<a disabled class="btn btn-success"><span class="glyphicon glyphicon-plus-sign"></span> Assign Subject</a>***This AY and Term is already expired.';
